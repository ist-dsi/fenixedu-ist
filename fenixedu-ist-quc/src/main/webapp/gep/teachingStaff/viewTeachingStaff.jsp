...
<h3><bean:message key="title.inquiries.nonAffiliatedTeachers" arg0="<%=org.fenixedu.academic.domain.organizationalStructure.Unit.getInstitutionAcronym()%>" bundle="INQUIRIES_RESOURCES" /></h3>
...
<h3><bean:message key="title.inquiries.insertNonAffiliatedTeacher" arg0="<%=org.fenixedu.academic.domain.organizationalStructure.Unit.getInstitutionAcronym()%>" bundle="INQUIRIES_RESOURCES" /></h3>
<table>	
