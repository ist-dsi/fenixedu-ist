...
<bean:define id="executionSemesterBean" name="executionSemesterBean" type="pt.ist.fenixedu.quc.dto.DepartmentExecutionSemester"/>
...
<p class="mvert15">
	<fr:form>
		<fr:edit id="executionSemesterBean" name="executionSemesterBean">
			<fr:schema bundle="INQUIRIES_RESOURCES" type="pt.ist.fenixedu.quc.dto.DepartmentExecutionSemester">
