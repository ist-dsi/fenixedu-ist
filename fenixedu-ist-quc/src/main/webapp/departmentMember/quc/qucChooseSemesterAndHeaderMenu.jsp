...
<bean:define id="executionSemesterBean" name="executionSemesterBean" type="org.fenixedu.academic.dataTransferObject.inquiries.DepartmentExecutionSemester"/>
...
<p class="mvert15">
	<fr:form>
		<fr:edit id="executionSemesterBean" name="executionSemesterBean">
			<fr:schema bundle="INQUIRIES_RESOURCES" type="org.fenixedu.academic.dataTransferObject.inquiries.DepartmentExecutionSemester">
