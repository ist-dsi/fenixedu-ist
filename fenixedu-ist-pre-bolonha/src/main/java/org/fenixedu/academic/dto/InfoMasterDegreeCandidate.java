...
public class InfoMasterDegreeCandidate extends InfoObject {
    ...
    public InfoMasterDegreeCandidate(InfoPerson person, InfoExecutionDegree executionDegree, Integer candidateNumber,
            Specialization specialization, String majorDegree, String majorDegreeSchool, Integer majorDegreeYear, Double average,
            Boolean courseAssistant, String coursesToAssist, InfoTeacher infoGuider, Boolean hasGuider) {
    ...
    public boolean equals(Object o) {
        return ((o instanceof InfoMasterDegreeCandidate)
                ...
                ((this.infoPerson.equals(((InfoMasterDegreeCandidate) o).getInfoPerson()))
                        && (this.specialization.equals(((InfoMasterDegreeCandidate) o).getSpecialization())) && (this.infoExecutionDegree
    ...
    public void copyFromDomain(MasterDegreeCandidate masterDegreeCandidate) {
        ...
        if (masterDegreeCandidate != null) {
            ...
            setInfoCandidateSituation(InfoCandidateSituation.newInfoFromDomain(masterDegreeCandidate
