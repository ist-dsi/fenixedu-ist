...
<%@page import="pt.ist.fenixedu.parking.domain.ParkingDocumentType"%>
...
<bean:define id="parkingRequest" name="parkingRequest" type="pt.ist.fenixedu.parking.domain.ParkingRequest"/>
