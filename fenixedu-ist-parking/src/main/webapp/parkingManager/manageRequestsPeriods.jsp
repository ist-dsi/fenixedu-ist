...
<logic:present name="parkingRequestPeriodToEdit">
	...
	<fr:edit id="parkingRequestPeriodToEdit" name="parkingRequestPeriodToEdit" schema="show.parkingRequestPeriod" action="/manageParkingPeriods.do?method=prepareManageRequestsPeriods" type="pt.ist.fenixedu.parking.domain.ParkingRequestPeriod">
...
<logic:notPresent name="parkingRequestPeriodToEdit">
	...
	<fr:form action="/manageParkingPeriods.do?method=prepareManageRequestsPeriods">
		<fr:create id="aa" schema="show.parkingRequestPeriod" type="pt.ist.fenixedu.parking.domain.ParkingRequestPeriod">
			<fr:layout name="tabular">
