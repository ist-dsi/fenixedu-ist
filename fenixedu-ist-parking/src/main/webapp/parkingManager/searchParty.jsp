...
<logic:present name="searchPartyBean">
	...
	<logic:notEmpty name="searchPartyBean" property="party">
		...
		<logic:notEmpty name="searchPartyBean" property="party.parkingParty">
			<bean:define id="parkingParty" name="searchPartyBean" property="party.parkingParty" type="pt.ist.fenixedu.parking.domain.ParkingParty"/>
		...
		<logic:iterate id="party" name="partyList">
			...
			<tr>
				...
				<td class="nowrap" rowspan="<%= numberUnits %>">
					<bean:define id="searchPartyBean" name="searchPartyBean" type="pt.ist.fenixedu.parking.dto.SearchParkingPartyBean"/>
