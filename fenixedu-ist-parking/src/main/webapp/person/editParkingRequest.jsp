...
<logic:present name="parkingParty">
	...
	<bean:define id="type" value="pt.ist.fenixedu.parking.domain.ParkingRequest$ParkingRequestFactoryCreator"/>
	...
	<logic:notEmpty name="parkingParty" property="parkingRequestsSet">
		...
		<bean:define id="type" value="pt.ist.fenixedu.parking.domain.ParkingRequest$ParkingRequestFactoryEditor"/>
	</logic:notEmpty>
	...
	<fr:form action="<%= "/personParking.do?method="+method%>" encoding="multipart/form-data">
		...
		<div id="driverLicenseRadio">	
			<div id="driverLicenseDivTop" style="display:none"></div>
				<p>
					<html:radio bundle="PARKING_RESOURCES" altKey="radio.driverLicense" name="personParkingForm" property="driverLicense" value="ALREADY_DELIVERED_HARD_COPY" onclick="changeElementsDisplay('driverLicenseDiv','driverLicenseFile', 'none', 'block')">
						<bean:message key="label.deliveredDocument" bundle="PARKING_RESOURCES" arg0="<%=driverLicenseLabel%>"/>
					</html:radio>
				</p>

				<p>
					<html:radio bundle="PARKING_RESOURCES" altKey="radio.driverLicense" name="personParkingForm" property="driverLicense" value="WILL_DELIVER_HARD_COPY" onclick="changeElementsDisplay('driverLicenseDiv','driverLicenseFile', 'none', 'block')">
						<bean:message key="label.willdeliverDocument" bundle="PARKING_RESOURCES" arg0="<%=driverLicenseLabel%>"/>
					</html:radio>
				</p>

				<p>
					<html:radio bundle="PARKING_RESOURCES" altKey="radio.driverLicense" name="personParkingForm" property="driverLicense" value="ELECTRONIC_DELIVERY" onclick="changeElementsDisplay('driverLicenseDiv','driverLicenseFile', 'block', 'none')">
...
<p class="mvert2">
	...
	<html:radio bundle="PARKING_RESOURCES" altKey="radio.vehicle2" styleId="hasVehicle2radio2" name="personParkingForm" property="vehicle2" value="false" onclick="document.getElementById('hasVehicle2').style.display='none'"/>
		<bean:message key="1.cap" bundle="ENUMERATION_RESOURCES"/> 
	<html:radio bundle="PARKING_RESOURCES" altKey="radio.vehicle2" styleId="hasVehicle2radio1" name="personParkingForm" property="vehicle2" value="true" onclick="document.getElementById('hasVehicle2').style.display='block'"/>
		...
		<div id="registry1Radio">
			<table class="tstyle8 thright thlight mtop0 mbottom0">
				<tr>
					...
					<td>
						<p>
						<html:radio bundle="PARKING_RESOURCES" altKey="radio.registry1" name="personParkingForm" property="registry1" value="ALREADY_DELIVERED_HARD_COPY" onclick="changeElementsDisplay('registry1Div','registry1File', 'none', 'block')">
							<bean:message key="label.deliveredDocument" bundle="PARKING_RESOURCES" arg0="<%=propertyRegisterLabel%>"/>
						</html:radio>
						</p>
						<p>
						<html:radio bundle="PARKING_RESOURCES" altKey="radio.registry1" name="personParkingForm" property="registry1" value="WILL_DELIVER_HARD_COPY" onclick="changeElementsDisplay('registry1Div','registry1File', 'none', 'block')">
							<bean:message key="label.willdeliverDocument" bundle="PARKING_RESOURCES" arg0="<%=propertyRegisterLabel%>"/>
						</html:radio>
						</p>
						<p>
						<html:radio bundle="PARKING_RESOURCES" altKey="radio.registry1" name="personParkingForm" property="registry1" value="ELECTRONIC_DELIVERY" onclick="changeElementsDisplay('registry1Div','registry1File', 'block', 'none')">
	...
	<div class="separator1"></div>
			...
			<p>
				...
				<html:radio bundle="PARKING_RESOURCES" altKey="radio.ownVehicle1" styleId="ownCar1radio1" name="personParkingForm" property="ownVehicle1" value="true" onclick="document.getElementById('ownCar1').style.display='none'"/>
					<bean:message key="label.yes" bundle="PARKING_RESOURCES"/>
				<html:radio bundle="PARKING_RESOURCES" altKey="radio.ownVehicle1" styleId="ownCar1radio2" name="personParkingForm" property="ownVehicle1" value="false" onclick="document.getElementById('ownCar1').style.display='block'"/>
	...
	<div class="separator1"></div>
		...
		<div id="declaration1Radio">
			...
			<tr>
				...
				<td>
					<p>
					<html:radio bundle="PARKING_RESOURCES" altKey="radio.declaration1" name="personParkingForm" property="declaration1" value="WILL_DELIVER_HARD_COPY" onclick="changeElementsDisplay('declaration1Div','Id1File', 'none', 'block')">
						<bean:message key="label.willdeliverDocument" bundle="PARKING_RESOURCES" arg0="<%=authorizationDeclaration%>"/>
					</html:radio>				
					</p>
					<p>
					<html:radio bundle="PARKING_RESOURCES" altKey="radio.declaration1" name="personParkingForm" property="declaration1" value="ELECTRONIC_DELIVERY" onclick="changeElementsDisplay('declaration1Div','declaration1File', 'block', 'none')">
...
<div id="hasVehicle2">
		...
		<div id="registry2Radio">
			<table class="tstyle8 thright thlight mtop0 mbottom0">
				<tr>
					...
					<td>
						<p>
						<html:radio bundle="PARKING_RESOURCES" altKey="radio.registry2" name="personParkingForm" property="registry2" value="ALREADY_DELIVERED_HARD_COPY" onclick="changeElementsDisplay('registry2Div','registry2File', 'none', 'block')">
							<bean:message key="label.deliveredDocument" bundle="PARKING_RESOURCES" arg0="<%=propertyRegisterLabel%>"/>
						</html:radio>
						</p>
						<p>
						<html:radio bundle="PARKING_RESOURCES" altKey="radio.registry2" name="personParkingForm" property="registry2" value="WILL_DELIVER_HARD_COPY" onclick="changeElementsDisplay('registry2Div','registry2File', 'none', 'block')">
							<bean:message key="label.willdeliverDocument" bundle="PARKING_RESOURCES" arg0="<%=propertyRegisterLabel%>"/>
						</html:radio>
						</p>						
						<p>
						<html:radio bundle="PARKING_RESOURCES" altKey="radio.registry2" name="personParkingForm" property="registry2" value="ELECTRONIC_DELIVERY" onclick="changeElementsDisplay('registry2Div','registry2File', 'block', 'none')">
							<bean:message key="label.deliverOnlineDocument" bundle="PARKING_RESOURCES" arg0="<%=propertyRegisterLabel%>"/>
						</html:radio>
						</p>
	...
	<div class="separator1"></div>
			...
			<p>
				<bean:message key="label.ownVehicle" bundle="PARKING_RESOURCES"/>? 
				<html:radio bundle="PARKING_RESOURCES" altKey="radio.ownVehicle2" styleId="ownCar2radio1" name="personParkingForm" property="ownVehicle2" value="true" onclick="document.getElementById('ownCar2').style.display='none'"/>
					<bean:message key="label.yes" bundle="PARKING_RESOURCES"/>
				<html:radio bundle="PARKING_RESOURCES" altKey="radio.ownVehicle2" styleId="ownCar2radio2" name="personParkingForm" property="ownVehicle2" value="false" onclick="document.getElementById('ownCar2').style.display='block'"/>
					<bean:message key="label.no" bundle="PARKING_RESOURCES"/>	
			</p>
		...
		<div id="declaration2Radio">
			<table class="tstyle8 thright thlight mtop0 mbottom0">
				<tr>
					...
					<td>
						<p>
						<html:radio bundle="PARKING_RESOURCES" altKey="radio.declaration2" name="personParkingForm" property="declaration2" value="WILL_DELIVER_HARD_COPY" onclick="changeElementsDisplay('declaration2Div','declaration2File', 'none', 'block')">
							<bean:message key="label.willdeliverDocument" bundle="PARKING_RESOURCES" arg0="<%=authorizationDeclaration%>"/>
						</html:radio>
						</p>
						<p>				
						<html:radio bundle="PARKING_RESOURCES" altKey="radio.declaration2" name="personParkingForm" property="declaration2" value="ELECTRONIC_DELIVERY" onclick="changeElementsDisplay('declaration2Div','declaration2File', 'block', 'none')">
							<bean:message key="label.deliverOnlineDocument" bundle="PARKING_RESOURCES" arg0="<%=authorizationDeclaration%>"/>
						</html:radio>
						</p>
	...
	<div class="separator1"></div>
		...
		<logic:notEqual name="parkingParty" property="partyClassification" value="TEACHER">
			<logic:notEqual name="parkingParty" property="partyClassification" value="EMPLOYEE">		
				<div class="mtop2">
					...
					<div class="infoop2">
						<bean:define id="link"><html:link page="/personParking.do?method=downloadParkingRegulamentation"><bean:message key="link.regulation" bundle="PARKING_RESOURCES"/></html:link></bean:define>
		...
		<p class="mtop2">
			<input alt="input.input" type="submit" value="<%= submit.toString() %>" />		
		</p>
