...
import pt.ist.fenixedu.vigilancies.service.AddExamCoordinator;
import pt.ist.fenixedu.vigilancies.service.DeleteExamCoordinator;
import pt.ist.fenixedu.vigilancies.ui.struts.action.vigilancy.examCoordination.ExamCoordinationApplication;
import pt.ist.fenixframework.FenixFramework;

@StrutsFunctionality(app = ExamCoordinationApplication.class, path = "manage-coordinators",
        titleKey = "label.vigilancy.manageExamCoordinator")
@Mapping(module = "examCoordination", path = "/vigilancy/examCoordinatorManagement")
