		...
		<fr:edit id="importation.bean.edit" name="importationBean">
			<fr:schema bundle="MANAGER_RESOURCES" type="pt.ist.fenixedu.integration.ui.struts.action.manager.student.importation.DgesStudentImportationProcessDA$DgesBaseProcessBean">
				...
				<fr:slot name="phase" layout="menu-select" key="label.dges.importation.process.entry.phase" required="true" >
					<fr:property name="providerClass" value="pt.ist.fenixedu.integration.ui.struts.action.manager.student.importation.DgesStudentImportationProcessDA$EntryPhaseProvider" />
