...
<logic:notEmpty name="importationJobsDone" >
	<fr:view name="importationJobsDone" >
		<fr:schema bundle="MANAGER_RESOURCES" type="pt.ist.fenixedu.integration.domain.student.importation.DgesStudentImportationProcess">
...
<logic:notEmpty name="exportationPasswordsDone" >
	<fr:view name="exportationPasswordsDone" >
		<fr:schema bundle="MANAGER_RESOURCES" type="pt.ist.fenixedu.integration.domain.student.importation.ExportDegreeCandidaciesByDegreeForPasswordGeneration">
