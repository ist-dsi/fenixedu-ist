...
<logic:present role="role(MANAGER)">
	...
	<logic:empty name="persistentGroup">		
		<fr:create type="pt.ist.fenixedu.integration.domain.accessControl.PersistentGroupMembers"
	...
	<logic:notEmpty name="persistentGroup">
		...
		<logic:notEmpty name="persistentGroup" property="persons">	
			<bean:define id="persistentGroup" name="persistentGroup" type="pt.ist.fenixedu.integration.domain.accessControl.PersistentGroupMembers"/>
