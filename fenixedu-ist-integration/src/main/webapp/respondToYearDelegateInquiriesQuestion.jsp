...
<html:html xhtml="true">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div align="center">
            	<a tabindex="2" href="${pageContext.request.contextPath}/respondToYearDelegateInquiriesQuestion.do?method=respondNow" class="btn btn-default"><bean:message key="button.inquiries.respond.now" /></a>
