    ...
    <body>
        ...
        <div class="container">
            ...
            <div id="txt">
                ...
                <p><bean:message key="message.alumni.data.reminder.moreInformation" bundle="APPLICATION_RESOURCES" />: <a href="<%= org.fenixedu.academic.domain.Installation.getInstance().getInstituitionURL() %>pt/alumni-e-parceiros/alumni/" target="_blank"><%= org.fenixedu.academic.domain.Installation.getInstance().getInstituitionURL() %>pt/alumni-e-parceiros/alumni/</a></p>
            </div>
