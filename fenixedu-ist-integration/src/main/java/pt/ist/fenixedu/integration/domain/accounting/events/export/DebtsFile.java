...
public abstract class DebtsFile extends DebtsFile_Base {
    ...
    static {
        ENTITY_CODE = FenixEduAcademicConfiguration.getConfiguration().getSibsEntityCode();
        SOURCE_INSTITUTION_ID = FenixEduIstIntegrationConfiguration.getConfiguration().getSibsSourceInstitutionId();
        DESTINATION_INSTITUTION_ID = FenixEduIstIntegrationConfiguration.getConfiguration().getSibsDestinationInstitutionId();
    }
