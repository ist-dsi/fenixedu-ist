...
public class ActivePhdStudentsGroup extends GroupStrategy {
    ...
    public Set<User> getMembers() {
        return Bennu.getInstance().getPhdProgramsSet().stream()
                ...
                .filter(process -> process.isProcessActive())
    ...
    public boolean isMember(User user) {
        ...
        return person.getStudent() != null
                && person.getPhdIndividualProgramProcessesSet().stream().anyMatch(PhdIndividualProgramProcess::isProcessActive);
    }
