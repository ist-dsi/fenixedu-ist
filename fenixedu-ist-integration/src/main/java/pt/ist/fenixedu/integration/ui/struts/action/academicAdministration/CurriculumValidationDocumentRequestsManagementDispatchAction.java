...
@Mapping(path = "/curriculumValidationDocumentRequestsManagement", module = "academicAdministration",
        functionality = AcademicAdminOfficeCurriculumValidationDA.class)
@Forwards({
        @Forward(name = "printDocument", path = "/academicAdministration/curriculumValidation/documentRequests/printDocument.jsp"),
        @Forward(name = "viewDocuments", path = "/academicAdministration/curriculumValidation/documentRequests/viewDocuments.jsp"),
        @Forward(name = "notValidDocument",
                path = "/academicAdministration/curriculumValidation/documentRequests/notValidDocument.jsp") })
