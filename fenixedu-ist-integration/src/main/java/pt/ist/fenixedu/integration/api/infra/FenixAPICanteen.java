...
import pt.ist.fenixedu.integration.FenixEduIstIntegrationConfiguration.ConfigurationProperties;
...
public class FenixAPICanteen {
    ...
    private static String getServiceAuth() {
        ConfigurationProperties config = FenixEduIstIntegrationConfiguration.getConfiguration();
