...
<fr:view name="teacherService">
	<fr:schema bundle="TEACHER_CREDITS_SHEET_RESOURCES" type="pt.ist.fenixedu.teacher.evaluation.domain.teacher.TeacherService">
...
<logic:present name="teacherServiceComment">
	<fr:edit id="teacherServiceComment" name="teacherServiceComment" action="<%="/credits.do?method=viewAnnualTeachingCredits&executionYearOid="+executionYearOid+"&teacherOid="+teacherOid %>">
		<fr:schema type="pt.ist.fenixedu.teacher.evaluation.domain.teacher.TeacherServiceComment" bundle="TEACHER_CREDITS_SHEET_RESOURCES">
...
<logic:notPresent name="teacherServiceComment">
	<fr:create action="<%="/credits.do?method=viewAnnualTeachingCredits&executionYearOid="+executionYearOid+"&teacherOid="+teacherOid %>" type="pt.ist.fenixedu.teacher.evaluation.domain.teacher.TeacherServiceComment"
