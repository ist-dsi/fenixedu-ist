...
<logic:present name="reductionService">
	...
	<fr:edit id="reductionService" name="reductionService" action="<%="/credits.do?method=viewAnnualTeachingCredits&executionYearOid="+executionYearOid+"&teacherOid="+teacherOid %>">
		<fr:schema type="pt.ist.fenixedu.teacher.evaluation.domain.teacher.ReductionService" bundle="TEACHER_CREDITS_SHEET_RESOURCES">
...
<logic:notPresent name="reductionService">
	<br/><br/>
	<fr:create action="<%="/credits.do?method=viewAnnualTeachingCredits&executionYearOid="+executionYearOid+"&teacherOid="+teacherOid %>" type="pt.ist.fenixedu.teacher.evaluation.domain.teacher.ReductionService"
