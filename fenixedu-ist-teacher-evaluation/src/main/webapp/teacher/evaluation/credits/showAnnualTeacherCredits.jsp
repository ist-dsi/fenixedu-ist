...
--%>
<%@page import="pt.ist.fenixedu.teacher.evaluation.domain.SupportLesson"%>
...
<logic:present name="annualTeachingCreditsBean">
	...
	<table class="headerTable"><tr>	
		...
		<fr:view name="annualTeachingCreditsBean">
			<fr:schema bundle="TEACHER_CREDITS_SHEET_RESOURCES" type="pt.ist.fenixedu.teacher.evaluation.domain.credits.util.AnnualTeachingCreditsBean">
...
<logic:notEqual name="areCreditsCalculated" value="true">
	<div class="infoop2">
		<logic:iterate id="annualTeachingCreditsByPeriodBean" name="annualTeachingCreditsBean" property="annualTeachingCreditsByPeriodBeans">
			<%
				final ExecutionSemester executionSemester = ((pt.ist.fenixedu.teacher.evaluation.domain.credits.util.AnnualTeachingCreditsByPeriodBean) annualTeachingCreditsByPeriodBean).getExecutionPeriod();
	...
	<div class="inner-panel" style="display: none;">
		<logic:iterate id="annualTeachingCreditsByPeriodBean" name="annualTeachingCreditsBean" property="annualTeachingCreditsByPeriodBeans">
			...
			<fr:view name="annualTeachingCreditsByPeriodBean" property="institutionWorkTime">
				<fr:schema bundle="TEACHER_CREDITS_SHEET_RESOURCES" type="pt.ist.fenixedu.teacher.evaluation.domain.teacher.InstitutionWorkTime">
		...
		<logic:iterate id="annualTeachingCreditsByPeriodBean" name="annualTeachingCreditsBean" property="annualTeachingCreditsByPeriodBeans">
			...
			<logic:notEmpty name="otherServices">
				<fr:view name="annualTeachingCreditsByPeriodBean" property="otherServices">
					<fr:schema bundle="TEACHER_CREDITS_SHEET_RESOURCES" type="pt.ist.fenixedu.teacher.evaluation.domain.teacher.OtherService">
	...
	<div class="inner-panel" style="display: none;">
		<logic:equal name="annualTeachingCreditsBean" property="canSeeCreditsReduction" value="true">
			<fr:view name="annualTeachingCreditsBean" property="annualTeachingCreditsByPeriodBeans">
				<fr:schema bundle="TEACHER_CREDITS_SHEET_RESOURCES" type="pt.ist.fenixedu.teacher.evaluation.domain.credits.util.AnnualTeachingCreditsByPeriodBean">
