...
<logic:present name="professorship">
	...
	<logic:notPresent name="supportLesson">
		<fr:create id="supportLesson" schema="manage.supportLesson" type="pt.ist.fenixedu.teacher.evaluation.domain.SupportLesson" action="<%="/degreeTeachingServiceManagement.do?method=showTeachingServiceDetails&professorshipID="+professorshipID %>">
