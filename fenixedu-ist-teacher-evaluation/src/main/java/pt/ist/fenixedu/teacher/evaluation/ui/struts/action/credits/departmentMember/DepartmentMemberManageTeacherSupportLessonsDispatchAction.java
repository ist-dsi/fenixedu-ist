...
import pt.ist.fenixedu.teacher.evaluation.ui.struts.action.credits.ManageTeacherSupportLessonsDispatchAction;
...
@Forwards({
        ...
        @Forward(name = "successfull-edit",
                path = "/departmentMember/degreeTeachingServiceManagement.do?method=showTeachingServiceDetails"),
        @Forward(name = "edit-support-lesson", path = "/teacher/evaluation/credits/supportLessons/editSupportLesson.jsp"),
