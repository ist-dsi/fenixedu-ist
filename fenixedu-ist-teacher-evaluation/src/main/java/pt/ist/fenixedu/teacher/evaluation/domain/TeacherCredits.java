...
public class TeacherCredits extends TeacherCredits_Base {
    ...
    static public ExecutionSemester readStartExecutionSemesterForCredits() {
        String yearString = TeacherEvaluationConfiguration.getConfiguration().getStartYearForCredits();
        String semesterString = TeacherEvaluationConfiguration.getConfiguration().getStartSemesterForCredits();
    ...
    static public ExecutionSemester readLastExecutionSemesterForCredits() {
        String yearString = TeacherEvaluationConfiguration.getConfiguration().getLastYearForCredits();
        String semesterString = TeacherEvaluationConfiguration.getConfiguration().getLastSemesterForCredits();
