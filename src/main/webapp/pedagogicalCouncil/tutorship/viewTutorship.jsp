...
<%@page import="pt.ist.fenixedu.tutorship.ui.Action.pedagogicalCouncil.TutorshipPeriodPartialBean"%>
...
<logic:present name="periodBean">
	...
	<bean:define id="periodBean" type="pt.ist.fenixedu.tutorship.ui.Action.pedagogicalCouncil.TutorshipPeriodPartialBean" name="periodBean" />
	...
	<fr:form action="/viewTutorship.do?method=changeTutorship">
		<fr:edit id="periodBean" name="periodBean">
			<fr:schema bundle="PEDAGOGICAL_COUNCIL"
				type="pt.ist.fenixedu.tutorship.ui.Action.pedagogicalCouncil.TutorshipPeriodPartialBean">
				...
				<fr:slot name="teacher" layout="menu-select"
					...
					<fr:property name="providerClass"
						value="pt.ist.fenixedu.tutorship.ui.Action.pedagogicalCouncil.TeacherTutorshipCreationBean$TutorsProvider" />
