...
<fr:form action="/studentHighPerformance.do?method=listRequests">
	<fr:create id="job" type="pt.ist.fenixedu.tutorship.domain.StudentHighPerformanceQueueJob">
		<fr:schema bundle="PEDAGOGICAL_COUNCIL" type="pt.ist.fenixedu.tutorship.domain.StudentHighPerformanceQueueJob">
...
<fr:view name="jobs">
	<fr:schema type="pt.ist.fenixedu.tutorship.domain.StudentHighPerformanceQueueJob" bundle="PEDAGOGICAL_COUNCIL">
