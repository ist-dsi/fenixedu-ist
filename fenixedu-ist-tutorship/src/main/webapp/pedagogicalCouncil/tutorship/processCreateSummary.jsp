...
<fr:form action="/tutorshipSummary.do">
	...
	<table class="tstyle1 thlight mtop0 mbottom15 tdleft">
		<tr>
			...
			<td><fr:view name="createSummaryBean" property="tutorshipSummaryProgramAssessment" type="pt.ist.fenixedu.tutorship.domain.TutorshipSummaryProgramAssessment" /></td>
		</tr>
	</table>
