...
<logic:notPresent name="teacherServiceComment">
	<fr:create action="<%="/credits.do?method=viewAnnualTeachingCredits&executionYearOid="+executionYearOid+"&teacherOid="+teacherOid %>" type="pt.ist.fenixedu.teacher.domain.teacher.TeacherServiceComment"
